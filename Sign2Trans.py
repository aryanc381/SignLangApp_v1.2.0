...
def correct_grammar_with_deepseek(text):
    ...
    if response.status_code == 200:
        ...
        print("Grammar correction failed:", response.text)
        return text

# Configuration
actions = np.array(['hello', 'mandar', 'language', 'my', 'name', 'i', 'internet', 'computer', 'data-entry', 'one', 'please'])
label_map = {label:num for num, label in enumerate(actions)}
model = tf.keras.models.load_model(r'best_model_withGPU3.h5', compile=False)
colors = [(245,117,16), (117,245,16), (16,117,245), (66, 245, 200), (200, 66, 245),
          (255, 255, 0), (255, 0, 255), (0, 255, 255), (150, 100, 255), (255, 100, 100), (0, 200, 100)]
